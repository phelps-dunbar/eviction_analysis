...
def get_insights(county, category, client):
    if (category is None) or (client is None) or (client is None):
        ...
        county_list = ["Dallas", "Mclennan", "Denton", "Tarrant", "Collin", "Travis", "Williamson", "Taylor", "Smith", "General legal advice", "Comal"]
        category_list = ["Non-payment eviction at JP", "Non-payment eviction appeal", "Non-payment  eviction at JP and appeal at County Court", "Small claims lawsuit by tenant & prohibited conduct eviction at JP", "Small claims lawsuit by tenant", "Non-payment eviction at JP and Bankruptcy", "Prohibited conduct eviction at JP", "Prohibited conduct eviction at County Court", "Demand letter from tenant regarding lease violations", "Non-payment eviction appeal at JP", "Non-payment eviction appeal at County Court and Court of Appeals"]
